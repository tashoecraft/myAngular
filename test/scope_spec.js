...
describe("Scope", function() {
    ...
    describe("digest", function() {
        ...
        it("ends the digest when the last watch is clean", function() {
            ...
            _.times(100, function(i) {
                scope.$watch(
                    ...
                    function(newVaue, oldValue, scope){}
                );
            });
        ...
        it("executes $evalAsync'ed functions added by watch functions", function() {
            ...
            scope.$watch(
                function(scope) {
                    if(!scope.asyncEvaluted) {
                        scope.$evalAsync(function(scope) {
                            scope.asyncEvaluted = true;
                        });
                    }
                    return scope.aValue;
                },
            ...
            scope.$digest();
            expect(scope.asyncEvaluted).toBe(true);
        });
        ...
        it("never executes $appplyAsync'ed function in the same cycle", function(done) {
            scope.aValue = [1,2,3];
        ...
        it("allows destroying a $watch during digest", function() {
            ...
            scope.$digest();
            expect(watchCalls).toEqual(['first', 'second',
            'third', 'first', 'third']);
        });
    ...
    describe('$watchGroup', function() {
        ...
        it('users the same array of old and new values on first run', function() {
            var gotNewValues, gotOldValues;
    ...
    describe("inheritance", function() {
        ...
        it("does not shadow members of parent scope's attributes", function() {
            ...
            child.user.first = "Jill";

            expect(child.user.first).toBe('Jill');
            expect(child.user.last).toBe('Smith');
            expect(parent.user.first).toBe('Jill');
            expect(parent.user.last).toBe('Smith');
        });
        ...
        it("digests its isolated children", function() { var parent = new Scope();
            var child = parent.$new(true);
            child.aValue = 'abc';
            child.$watch(
        ...
        it("executes $evalAsync functions on isolated scopes", function(done) { var parent = new Scope();
            var child = parent.$new(true);
        ...
        it("executes $$postDigest functions on isolated scopes", function() { var parent = new Scope();
            var child = parent.$new(true);
    ...
    describe("$watchCollection", function() {
        ...
        it("notices items reordered in an array", function() { scope.arr = [2, 1, 3];
            scope.counter = 0;
            scope.$watchCollection(
                function(scope) { return scope.arr; }, function(newValue, oldValue, scope) {
                    scope.counter++;
                }
            );
            scope.$digest();
